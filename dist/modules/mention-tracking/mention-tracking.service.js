        ...
        for (const [, entry] of influencerMap) {
            ...
            try {
                ...
                if (username && entry.inf.platform === 'INSTAGRAM') {
                    ...
                    const userInfo = await this.modashRawService.getTiktokUserInfo(username);
            ...
            if (fc >= 1000000)
                entry.inf.category = entities_1.InfluencerCategory.MEGA;
            else if (fc >= 100000)
                entry.inf.category = entities_1.InfluencerCategory.MACRO;
            else if (fc >= 10000)
                entry.inf.category = entities_1.InfluencerCategory.MICRO;
            else
                entry.inf.category = entities_1.InfluencerCategory.NANO;
